...
### Past/Current Research Projects with Students (as of 2026)
* Connecting p-adic eigenvalues and smith normal forms of matrices
...
* [Binomial prolate spheroidal functions, Pascal matrices, and arithmetic of elliptic curves](https://arxiv.org/abs/2508.08494) <br/> Proc. Natl. Acad. of Sci. USA (2026)
* [Reconstructing rational functions on finite Abelian groups with higher autocorrelations](https://arxiv.org/abs/2503.21022) <br/> Appl. Comput. Harmon. Anal. (2026)
* [The Pascal matrix, commuting tridiagonal operators and Fourier algebras](https://arxiv.org/abs/2407.21680) <br/> J. Linear Alg. Appl. (2025)
* [Matrix valued discrete-continuous functions with the prolate spheroidal property](https://arxiv.org/abs/2302.05750) <br/> Communications in Math. Phys. (2024)
* [Reflective prolate-spheroidal operators and the adelic Grassmannian](https://arxiv.org/abs/2003.11616) <br/> Communications in Pure and Applied Mathematics (2023)
* [Battleship, tomography, and quantum annealing](https://wcasper.github.io/math180fall2022/modules/battleship/battleship-tomography-quantum.pdf) Euro. J. Appl. Math. (2023)
...
* [Bivariate cont. q-Hermite polynomials and quantum Serre relations](https://arxiv.org/abs/2002.07895) <br/>  J. Algebra Appl. (2022)
